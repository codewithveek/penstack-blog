...
export function OrganizationStep({
  ...
  const validateForm = () => {
    ...
    if (
      ...
      !isValidEmail(formData.organizationEmail)
    ) {
  ...
  return (
    <VStack gap={6} align="stretch">
      <Text color="gray.600">
        Add organization details for structured data and SEO. This step is
        optional.
      </Text>
      ...
      {!skip && (
        <>
          ...
          <Field.Root>
            ...
            />
            <Field.HelperText>
              Full postal address (JSON format supported)
            </Field.HelperText>
          </Field.Root>
          ...
          <Field.Root>
            ...
            <Input
              ...
              onChange={(e) =>
                setFormData({
                  ...formData,
                  organizationFounder: e.target.value,
                })
              }
